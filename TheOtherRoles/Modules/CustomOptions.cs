...
namespace TheOtherRoles
{
    ...
    public class CustomRoleOption : CustomOption
    {
            ...
            base(id, type, Helpers.cs(color, name), CustomOptionHolder.rates, "", null, true, false, "")
        {
            ...
            if (max > 1)
                countOption = Create(id + 10000, type, "roleNumAssigned", 1f, 1f, 15f, 1f, this, false, isHidden, "unitPlayers");
        }
    }
    ...
    public class CustomDualRoleOption : CustomRoleOption
    {
        ...
        {
            roleAssignEqually = new CustomOption(id + 100001, type, "roleAssignEqually", new string[] { "optionOn", "optionOff" }, "optionOff", this, false, isHidden, "");
